...
/**
 * Created by corina.armasu on 5/9/2018.
 */
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                String newsDate = "Unavailable Date";
                ...
                String newsAuthor = "Unavailable Author";
                ...
                if (tagsLength == 1) {
                    ...
                    String presentAuthor = currentNewsAuthor.getString("webTitle");
                    newsAuthor = "Author: " + presentAuthor;
                }
